...
export default function MedicaoProducaoPage() {
  // Estados
  const [medicoes, setMedicoes] = useState<MedicaoMP[]>([]);
    ...
    return (
      <div className="flex items-center justify-center h-full">
        <div className="text-center">
          ...
          <p className="text-gray-400">Selecione uma obra para visualizar as medições de produção.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-white">Medição de Produção (MP)</h1>
          <p className="text-gray-400 mt-1">Registro das quantidades executadas em campo</p>
        </div>
        <button
      ...
      <div className="flex items-center gap-4 p-4 bg-gray-900 rounded-lg border border-gray-800">
        ...
        <div className="flex items-center gap-2 text-sm">
          ...
          <span className="text-white font-semibold">{formatCurrency(totalValor)}</span>
        </div>
      </div>
      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="p-4 bg-gray-900 rounded-lg border border-gray-800">
          ...
          <p className="text-2xl font-bold text-white mt-1">{medicoes.length}</p>
        </div>
        <div className="p-4 bg-gray-900 rounded-lg border border-gray-800">
        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-800">
              ...
              <th className="px-4 py-3 text-center text-xs font-semibold text-gray-400 uppercase">Data</th>
          ...
          <tbody>
            {loading ? (
              ...
              <tr>
                <td colSpan={8} className="px-4 py-8 text-center text-gray-400">
                  Nenhuma medição encontrada para esta competência.
                </td>
              </tr>
            ) : (
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center justify-center gap-2">
                      {medicao.status === 'rascunho' && (
                        <>
                          <button
                            onClick={() => enviarParaAprovacao(medicao.id)}
        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
          <div className="bg-gray-900 rounded-lg border border-gray-800 w-full max-w-4xl max-h-[90vh] overflow-hidden">
            ...
            <div className="flex items-center justify-between p-4 border-b border-gray-800">
              <div>
                <h2 className="text-lg font-semibold text-white">Nova Medição de Produção</h2>
